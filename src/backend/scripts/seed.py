    ...
    async with AsyncSessionLocal() as db:
        ...
        items = [
            ...
            (
                ...
                "烤面包+煎蛋+咖啡",
                "Toasted bread, fried egg, coffee",
                8.80,
            ),
            (
                cat_ids["breakfast"],
            ...
            (
                ...
                "Waffle Set",
                "香草华夫饼+奶油+蜂蜜",
                "Vanilla waffle with cream and honey",
                6.80,
            ),
            (
                cat_ids["breakfast"],
            ...
            (
                ...
                "Singapore Laksa",
                "椰浆汤底配米粉、大虾、鱼丸",
                "Coconut broth, rice noodles, prawns, fish cake",
                13.80,
            ),
            (
                cat_ids["mains"],
                ...
                "Nasi Lemak",
                "香米+椰浆+花生+参巴酱+煎蛋",
                "Fragrant rice, coconut milk, peanuts, sambal, fried egg",
                12.50,
            ),
            (
                cat_ids["mains"],
                ...
                "Hokkien Prawn Mee",
                "黄面+大虾+蒜蓉+葱",
                "Yellow noodles, prawns, garlic, spring onion",
                14.00,
            ),
            (
                cat_ids["mains"],
                ...
                "白斩鸡+香米+辣椒酱",
                "Poached chicken, fragrant rice, chili sauce",
                11.80,
            ),
            (
                cat_ids["mains"],
                ...
                "Bak Kut Teh",
                "猪骨汤+蒜+胡椒+油条",
                "Pork rib soup, garlic, pepper, youtiao",
                12.80,
            ),
            (
                cat_ids["mains"],
                ...
                "Curry Fish Head",
                "红鱼头+茄子+豆腐+椰浆",
                "Red snapper head, eggplant, tofu, coconut milk",
                18.80,
            ),
            (
                cat_ids["mains"],
            ...
            (
                ...
                "Singapore Sling",
                "杜松子+樱桃白兰地+菠萝+柠檬",
                "Gin, cherry brandy, pineapple, lime",
                12.00,
            ),
            (
                cat_ids["drinks"],
            ...
            (
                ...
                "Matcha Latte",
                "抹茶+蒸奶+少许糖",
                "Matcha, steamed milk, light sugar",
                6.00,
            ),
            (
                cat_ids["drinks"],
                ...
                "Thai Milk Tea",
                "泰式红茶+淡奶+冰",
                "Thai black tea, evaporated milk, ice",
                5.00,
            ),
            (
                cat_ids["drinks"],
            ...
            (
                ...
                "Ice Kachang",
                "冰沙+红豆+椰奶+仙草",
                "Ice shave, red bean, coconut milk, grass jelly",
                5.00,
            ),
            (
                cat_ids["desserts"],
                ...
                "Durian Ice Kachang",
                "冰沙+榴莲肉+椰奶",
                "Ice shave, durian flesh, coconut milk",
                8.50,
            ),
            (
                cat_ids["desserts"],
                ...
                "Red Bean Ice",
                "冰沙+红豆+淡奶",
                "Ice shave, red bean, evaporated milk",
                4.50,
            ),
            (
                cat_ids["desserts"],
        ...
        seat_data = [
            ...
            ("T03", "室内 03", "Indoor 03", "indoor"),
            ("T04", "室内 04", "Indoor 04", "indoor"),
            ("T05", "室内 05", "Indoor 05", "indoor"),
            ("T06", "室内 06", "Indoor 06", "indoor"),
            ("T07", "室内 07", "Indoor 07", "indoor"),
            ("T08", "室内 08", "Indoor 08", "indoor"),
            ("T09", "室内 09", "Indoor 09", "indoor"),
            ("T10", "室内 10", "Indoor 10", "indoor"),
            ("T11", "室内 11", "Indoor 11", "indoor"),
            ("T12", "室内 12", "Indoor 12", "indoor"),
            ("O01", "户外 01", "Outdoor 01", "outdoor"),
            ("O02", "户外 02", "Outdoor 02", "outdoor"),
            ("O03", "户外 03", "Outdoor 03", "outdoor"),
            ("O04", "户外 04", "Outdoor 04", "outdoor"),
            ("B01", "吧台 01", "Bar 01", "bar"),
            ("B02", "吧台 02", "Bar 02", "bar"),
            ("B03", "吧台 03", "Bar 03", "bar"),
            ("B04", "吧台 04", "Bar 04", "bar"),
